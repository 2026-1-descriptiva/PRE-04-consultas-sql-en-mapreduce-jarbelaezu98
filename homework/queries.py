...
#import mapreduce.hadoop as run_mapreduce_job  # type: ignore erroneo: el espera un initializador y no una funcion, por eso se importa la funcion directamente
